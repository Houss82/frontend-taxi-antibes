...
<div class="kpi-strip">
  ...
  <span class="badge info">🏰 Vieux Antibes</span>
  <span class="badge success">🚢 Port Vauban</span>
  <span class="badge info">🏖️ Plages</span>
</div>
...
<details class="toc">
  ...
  <ol>
    ...
    <li><a href="#activites-nautiques">Activités nautiques</a></li>
...
## 🏛️ 1. Musées à Antibes : culture et art

Antibes compte **3 musées majeurs** qui offrent une découverte culturelle exceptionnelle, de l'art moderne au patrimoine historique.

### Musée Picasso (Château Grimaldi)

Le **Musée Picasso** est l'un des musées les plus célèbres de la Côte d'Azur et une destination incontournable à Antibes. Installé dans le **Château Grimaldi**, un monument historique du XVIe siècle qui domine la Méditerranée, ce musée abrite une collection exceptionnelle d'œuvres de Picasso créées lors de son séjour à Antibes en 1946. Pour connaître les expositions temporaires et réserver votre visite, consultez le <a href="https://www.antibes-juanlespins.com/sorties-loisirs/antibes-ville-de-culture/les-musees/le-musee-picasso" target="_blank" rel="noopener noreferrer">site officiel du Musée Picasso</a>.

**Collections :**

- **Plus de 200 œuvres de Picasso** : Peintures, dessins, céramiques créées en 1946
- **Collection d'art moderne et contemporain** : Œuvres de Nicolas de Staël, Miró, etc.
- **Expositions temporaires régulières** : Artistes contemporains et expositions thématiques
...
- **Accessibilité** : Accessible à pied depuis le centre-ville (5 min)
  ...
  <table style="width: 100%; border-collapse: collapse; margin: 1.5rem 0; min-width: 600px;">
    <thead>
      <tr style="background-color: #f3f4f6;">
        <th style="padding: 12px 8px; text-align: left; border: 1px solid #e5e7eb; font-size: 0.875rem;">Musée</th>
        ...
        <th style="padding: 12px 8px; text-align: left; border: 1px solid #e5e7eb; font-size: 0.875rem;">Tarifs</th>
        <th style="padding: 12px 8px; text-align: left; border: 1px solid #e5e7eb; font-size: 0.875rem;">Durée visite</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;"><strong>Musée Picasso</strong></td>
        ...
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">8€ plein tarif, 6€ tarif réduit</td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">1h30 à 2h</td>
      </tr>
      <tr>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;"><strong>Musée Peynet</strong></td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">Place Nationale, 06600 Antibes</td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">10h-12h et 14h-18h (fermé le lundi)</td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">4€ plein tarif, 2€ tarif réduit</td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">45 min à 1h</td>
      </tr>
      <tr>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;"><strong>Musée d'Archéologie</strong></td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">Bastion Saint-André, Avenue Général de Gaulle, 06600 Antibes</td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">10h-13h et 14h-18h (fermé le lundi)</td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">3€ plein tarif, gratuit -18 ans</td>
        <td style="padding: 12px 8px; border: 1px solid #e5e7eb;">1h à 1h30</td>
      </tr>
    </tbody>
  </table>
</div>
...
## 🏰 2. Vieux Antibes : le cœur historique

Le **Vieux Antibes** est le quartier historique de la ville, avec ses **ruelles étroites**, ses **remparts** et son **ambiance authentique**. Ce quartier médiéval est un incontournable de votre visite à Antibes.
...
- **Histoire** : Histoire militaire de la ville
...
### Rues commerçantes et Place Nationale
...
- **Place Nationale** : Place centrale animée avec cafés et restaurants
...
- **Observation** : Observation depuis les quais
...
- **Ambiance** : Ambiance maritime authentique
...
- **Vue** : Vue exceptionnelle sur les yachts
...
## 🏖️ 4. Les plages d'Antibes

Antibes dispose de plusieurs **plages** accessibles depuis le centre-ville, offrant une variété d'options pour tous les goûts.
...
- **Ambiance** : Ambiance calme et authentique
...
- **Activités** : Paddle, kayak (location sur place)
- **Proximité** : À pied depuis le centre-ville (10 min)
...
- **Vue magnifique** : Vue sur le Vieux Antibes et les Alpes
...
- **Activités nautiques** : Paddle, kayak, jet-ski, pédalos
- **Vie nocturne** : Vie nocturne animée en été
...
- **Tarifs** : Tarifs moyens à élevés (50-150€ par personne)
...
- **Localisation** : Dans le Vieux Antibes
...
## 🛍️ 6. Shopping et commerces

Le **centre-ville d'Antibes** regorge de boutiques et commerces pour tous les goûts et tous les budgets.
...
- **Parfums** : Parfumeries et cosmétiques
...
- **Commerces** : Commerces de proximité
...
- **Art** : Galeries d'art et antiquités
...
- **Créations** : Créations uniques et originales

---

## ⛵ 7. Activités nautiques

Antibes est un **paradis pour les activités nautiques** avec une variété d'options pour tous les niveaux.
...
- **Excursions** : Excursions organisées vers les meilleurs sites
...
- **Excursions** : Excursions à la journée ou demi-journée
...
- **Tarifs** : Tarifs abordables (15-30€/heure)
...
- **Initiation** : Initiation possible pour débutants
- **Tarifs** : Tarifs variables selon durée et circuits
...
Antibes est idéalement située pour explorer la Côte d'Azur avec de nombreuses destinations accessibles facilement.
...
<div class="faq-section space-y-4">
  ...
  <details class="group bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
    ...
    <div class="px-5 pb-5 bg-gray-50">
      Antibes compte plusieurs musées : le <strong>Musée Picasso</strong> (le plus célèbre, collection exceptionnelle), le <strong>Musée Peynet</strong> (dessins humoristiques) et le <strong>Musée d'Archéologie</strong> (histoire antique). Tous sont situés dans le centre-ville et accessibles à pied. Pour vous y rendre, réservez un <a href="/">taxi Antibes</a> au <a href="tel:+33749777621">07 49 77 76 21</a>.
    </div>
  </details>

  <details class="group bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
    <summary class="flex items-center justify-between px-5 py-4 cursor-pointer text-lg font-semibold text-cyan-700">
      Y a-t-il des plages à Antibes ?
      <span class="text-cyan-500 group-open:rotate-180">⌄</span>
    </summary>
    <div class="px-5 pb-5 bg-gray-50">
      Oui, Antibes dispose de plusieurs <strong>plages</strong> accessibles depuis le centre-ville : la <strong>plage de la Gravette</strong> (la plus proche), la <strong>plage du Ponteil</strong> (familiale avec équipements complets) et les <strong>plages de Juan-les-Pins</strong> (grandes plages de sable fin). Toutes sont accessibles à pied ou en taxi. Consultez notre <a href="/blog/plages-familiales-antibes-juan-les-pins-2025">guide des plages familiales</a>.
    </div>
  </details>

  <details class="group bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
    <summary class="flex items-center justify-between px-5 py-4 cursor-pointer text-lg font-semibold text-cyan-700">
      Comment se rendre au Port Vauban depuis le centre-ville ?
      <span class="text-cyan-500 group-open:rotate-180">⌄</span>
    </summary>
    <div class="px-5 pb-5 bg-gray-50">
  ...
  <details class="group bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
    ...
    <div class="px-5 pb-5 bg-gray-50">
      Oui, absolument ! Antibes est une ville <strong>facilement accessible à pied</strong> pour découvrir le centre-ville. Les transports en commun (bus Envibus) et notre <a href="/">service de taxi Antibes</a> permettent de vous déplacer confortablement vers l'aéroport ou les destinations de la Côte d'Azur. Consultez notre <a href="/blog/se-deplacer-antibes-sans-voiture-guide-2026">guide pour se déplacer à Antibes sans voiture</a>.
    </div>
  </details>

  <details class="group bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
    <summary class="flex items-center justify-between px-5 py-4 cursor-pointer text-lg font-semibold text-cyan-700">
      Quels sont les meilleurs restaurants à Antibes ?
      <span class="text-cyan-500 group-open:rotate-180">⌄</span>
    </summary>
    <div class="px-5 pb-5 bg-gray-50">
      Antibes compte plusieurs <strong>restaurants étoilés au Guide Michelin</strong> et de nombreux établissements récompensés. Le Vieux Antibes regorge également d'adresses authentiques pour découvrir la cuisine niçoise traditionnelle. Consultez notre <a href="/blog/meilleurs-restaurants-antibes-2025">guide complet des meilleurs restaurants d'Antibes</a>. Pour vous y rendre, réservez un <a href="/">taxi Antibes</a> au <a href="tel:+33749777621">07 49 77 76 21</a>.
    </div>
  </details>

  <details class="group bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
    <summary class="flex items-center justify-between px-5 py-4 cursor-pointer text-lg font-semibold text-cyan-700">
      Quelles activités nautiques peut-on faire à Antibes ?
      <span class="text-cyan-500 group-open:rotate-180">⌄</span>
    </summary>
    <div class="px-5 pb-5 bg-gray-50">
      Antibes est un <strong>paradis pour les activités nautiques</strong> : plongée sous-marine (sites exceptionnels), voile (écoles de voile et location de bateaux), paddle et kayak (location sur les plages), jet-ski (location et circuits), et croisières (excursions vers les îles de Lérins ou Monaco). De nombreuses activités sont disponibles pour tous les niveaux et tous les budgets.
    </div>
  </details>

  <details class="group bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
    <summary class="flex items-center justify-between px-5 py-4 cursor-pointer text-lg font-semibold text-cyan-700">
      Quelles excursions peut-on faire depuis Antibes ?
      <span class="text-cyan-500 group-open:rotate-180">⌄</span>
    </summary>
    <div class="px-5 pb-5 bg-gray-50">
...
👉 **[Guide week-end Antibes](/blog/week-end-antibes-guide-complet-visites-transports-2025)** : Itinéraire sur 2-3 jours
...
- **Saison** : Toute l'année, été pour plages et animation
