export const sectorData = {
  ...
  nice: {
    ...
    coverageAreas: [
      "✓ Nice centre-ville, Jean Médecin",
      "✓ Promenade des Anglais, hôtels du bord de mer",
      "✓ Quartiers Cimiez, Gairaut, Rimiez",
      "✓ Nice Ouest, Fabron, Caucade, Arenas",
      "✓ Nice Est, Riquier, Port de Nice",
      "✓ Collines niçoises et communes voisines",
    ],
    map: {
      description:
